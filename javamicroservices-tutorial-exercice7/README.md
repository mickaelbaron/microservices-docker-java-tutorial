...
- Copier le fichier `compose.yaml` dans un nouveau fichier nommé `composewithsh.yaml` et modifier la partie concernant le paramètre `depends_on` des services `rest` et `log`.
